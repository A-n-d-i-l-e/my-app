    ...
    <s.Screen>
      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          ...
          <s.Container
            ...
            style={{
              ...
              boxShadow: "0px 5px 8px 2px rgba(0,0,0,0.5)",
            }}
          >
            <s.TextTitle
              style={{
          ...
          <s.SpacerLarge />
          <s.Container flex={1} jc={"left"} ai={"right"}>
        ...
        <s.Container jc={"center"} ai={"center"} style={{ width: "50%" }}>
          ...
          >
            Welcome to the Dragon's Den please make sure you are connected to the right network to mint your Dragon (
